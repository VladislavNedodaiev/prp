...
if (isset($_SESSION['user']) && !isset($_GET['user_id']) || 
	isset($_SESSION['user']) && isset($_GET['user_id']) && $_SESSION['user']->user_id == $_GET['user_id'])
	$usr=$_SESSION['user'];
else if (!isset($_GET['user_id']))
	return "No such user can be found!";
else {
...
<div class="card" style="width: 60rem;">
	<div class="card-header">
		<div class="row">
			<div class="col-8 my-auto"><a href="#" value="templates/profile.php?user_id=<?php echo $_SESSION['user']->user_id; ?>"><?php echo $_SESSION['user']->login; ?></a></div>
			<div class="col text-right my-auto"><?php if (isset($_SESSION['user']) && $_SESSION['user']->user_id == $usr->user_id) echo '<a value="templates/become_premium.php" href="#"><i class="far fa-star"></i></i> Become a premium user </a><a value="templates/edit_profile.php" href="#"><i class="fas fa-pencil-alt"></i> Edit</a>';?></div>
		</div>
	</div>
